...
// public static int size_hight = 400;
...
public Okno() {
        ...
        button_wymiana_z_graczem.setBounds((int)size_width/50, (int)3*size_hight/4 - 2*(int)size_hight/20 - 100, (int)size_width/10, (int)size_hight/20);
