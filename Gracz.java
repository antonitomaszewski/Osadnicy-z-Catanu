...
public boolean czy_mozna_wymienic(int ile, String surowiec) {
        if (surowiec == "owca") {
                return surowce.owca >= ile && ile >= 0;
        } else if (surowiec == "siano") {
                return surowce.siano >= ile && ile >= 0;
        } else if (surowiec == "drewno") {
                return surowce.drewno >= ile && ile >= 0;
        } else if (surowiec == "cegla") {
                return surowce.cegla >= ile && ile >= 0;
        } else if (surowiec == "kamien") {
                return surowce.kamien >= ile && ile >= 0;
        }
        return false;
}
